...
<p><ul>
  <li><a href="https://knowledgedb.informatik.uni-bremen.de/">Knowledge DB</a>: Here you find the openly accessible server hosting my published knowledge graphs
  <li><a href="https://michaelakuempel.github.io/ProductKG/">Product KG</a>: My product knowledge graph website with all necessary sources and API to access the graph for applications.</li>
